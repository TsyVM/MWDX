// The loader log — MWDX.log, written beside the game executable.
//
...
// That is the first question to ask about any report of "MWDX isn't working",
// and keeping it in a short file of its own means the answer is not buried
// under thousands of lines of render tracing.
//
// The detailed diagnostic stream lives in MWDX-render.log and is produced by
