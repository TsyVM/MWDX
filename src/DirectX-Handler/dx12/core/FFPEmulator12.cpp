...
//
// Shares the shader generator with the D3D11 backend, so an identical
// permutation key yields identical HLSL. Differs only in compiling for the
// D3D12 targets and in owning the constant buffer as a D3D12 resource updated
// through the per-frame upload allocator.
