...
//
// As with the D3D11 backend, the device is never reported as lost. Modern APIs
// virtualise the GPU and a genuine loss is rare; claiming one sends the game
// into a recovery path with nothing to recover.
