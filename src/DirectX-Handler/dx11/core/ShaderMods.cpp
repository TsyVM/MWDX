...
//
//   MWDX\Shaders\          user-edited .hlsl files, loaded in place of ours
//   MWDX\Shaders\Dumped\   what MWDX generated, written for reference
//
...
// anything backend-specific, so the same file serves the DX11 and DX12
// backends. Fixed-function shaders have no bytecode to hash, so their
