// The renderer's diagnostic log -- MWDX-render.log, beside the executable.
//
...
#ifndef DX9TO11_LOG_H
#define DX9TO11_LOG_H
...
void DrainInfoQueue(ID3D11Device* dev) noexcept;

}
}

#define DXLOG_TRACE(...) ::dx9to11::log::Write(::dx9to11::log::Level::Trace, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
#define DXLOG_INFO(...)  ::dx9to11::log::Write(::dx9to11::log::Level::Info,  __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
#define DXLOG_WARN(...)  ::dx9to11::log::Write(::dx9to11::log::Level::Warn,  __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)
#define DXLOG_ERROR(...) ::dx9to11::log::Write(::dx9to11::log::Level::Error, __FILE__, __LINE__, __FUNCTION__, __VA_ARGS__)

#define DXLOG_HR(hr, ...)       ::dx9to11::log::WriteHR(::dx9to11::log::Level::Error, __FILE__, __LINE__, __FUNCTION__, (hr), __VA_ARGS__)
#define DXLOG_WARN_HR(hr, ...)  ::dx9to11::log::WriteHR(::dx9to11::log::Level::Warn,  __FILE__, __LINE__, __FUNCTION__, (hr), __VA_ARGS__)
#define DXLOG_FATAL_HR(hr, ...) ::dx9to11::log::WriteHR(::dx9to11::log::Level::Fatal, __FILE__, __LINE__, __FUNCTION__, (hr), __VA_ARGS__)

#define DX_FAILED(hr, ...)                                                       \
    ( FAILED(hr)                                                                 \
      ? (::dx9to11::log::WriteHR(::dx9to11::log::Level::Error, __FILE__,         \
